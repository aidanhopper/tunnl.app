...
const selectSharesByUserIdIR: any = {"usedParamSet":{"user_id":true},"params":[{"name":"user_id","required":false,"transform":{"type":"scalar"},"locs":[{"a":427,"b":434}]}],"statement":"SELECT \n    shares.*,\n    grantee.id AS grantee_user_id,\n    granter.id AS granter_user_id,\n    grantee.email AS grantee_email,\n    granter.email AS granter_email,\n    grantee.roles AS grantee_roles,\n    granter.roles AS granter_roles\nFROM shares\nJOIN users AS grantee ON shares.user_id = grantee.id\nJOIN services ON services.id = shares.service_id\nJOIN users AS granter ON services.user_id = granter.id\nWHERE shares.user_id = :user_id"};
...
const selectShareBySlugIR: any = {"usedParamSet":{"slug":true},"params":[{"name":"slug","required":false,"transform":{"type":"scalar"},"locs":[{"a":424,"b":428}]}],"statement":"SELECT \n    shares.*,\n    grantee.id AS grantee_user_id,\n    granter.id AS granter_user_id,\n    grantee.email AS grantee_email,\n    granter.email AS granter_email,\n    grantee.roles AS grantee_roles,\n    granter.roles AS granter_roles\nFROM shares\nJOIN users AS grantee ON shares.user_id = grantee.id\nJOIN services ON services.id = shares.service_id\nJOIN users AS granter ON services.user_id = granter.id\nWHERE shares.slug = :slug"};
...
const selectSharesByServiceIdIR: any = {"usedParamSet":{"service_id":true},"params":[{"name":"service_id","required":false,"transform":{"type":"scalar"},"locs":[{"a":423,"b":433}]}],"statement":"SELECT \n    shares.*,\n    grantee.id AS grantee_user_id,\n    granter.id AS granter_user_id,\n    grantee.email AS grantee_email,\n    granter.email AS granter_email,\n    grantee.roles AS grantee_roles,\n    granter.roles AS granter_roles\nFROM shares\nJOIN users AS grantee ON shares.user_id = grantee.id\nJOIN services ON services.id = shares.service_id\nJOIN users AS granter ON services.user_id = granter.id\nWHERE service_id = :service_id"};
